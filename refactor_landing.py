...
FILE = Path(r"c:\Users\user5\Desktop\Немцы\CRYPTO-TRADERS – KI für automatisierten Handel.html")

LOGO_SVG = (
    "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40'%3E"
    "%3Crect width='40' height='40' rx='6' fill='%23131722'/%3E"
    "%3Cpath d='M8 30 L14 22 L20 26 L32 12' stroke='%2300c805' stroke-width='2.5' fill='none' stroke-linecap='round'/%3E"
    "%3Ccircle cx='32' cy='12' r='2.5' fill='%2300c805'/%3E%3C/svg%3E"
)

HERO_TERMINAL = (
    "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 400'%3E"
    "%3Crect width='640' height='400' fill='%23131722'/%3E"
    "%3Crect x='0' y='0' width='640' height='36' fill='%231e222d'/%3E"
    "%3Ccircle cx='20' cy='18' r='5' fill='%23ef5350'/%3E%3Ccircle cx='38' cy='18' r='5' fill='%23ffc107'/%3E"
    "%3Ccircle cx='56' cy='18' r='5' fill='%2300c805'/%3E"
    "%3Ctext x='80' y='23' fill='%23b2b5be' font-family='monospace' font-size='12'%3ECrypto-Traders Terminal%3C/text%3E"
    "%3Crect x='0' y='36' width='140' height='364' fill='%231a1f2b'/%3E"
    "%3Ctext x='12' y='60' fill='%2300c805' font-size='11' font-family='monospace'%3EBTC/USDT +1.24%25%3C/text%3E"
    "%3Ctext x='12' y='80' fill='%23b2b5be' font-size='11' font-family='monospace'%3EETH/USDT -0.42%25%3C/text%3E"
    "%3Ctext x='12' y='100' fill='%23b2b5be' font-size='11' font-family='monospace'%3EXRP/USDT +0.18%25%3C/text%3E"
    "%3Crect x='150' y='50' width='8' height='120' fill='%2300c805'/%3E"
    "%3Crect x='165' y='80' width='8' height='90' fill='%23ef5350'/%3E"
    "%3Crect x='180' y='60' width='8' height='110' fill='%2300c805'/%3E"
    "%3Crect x='195' y='100' width='8' height='70' fill='%23ef5350'/%3E"
    "%3Crect x='210' y='45' width='8' height='125' fill='%2300c805'/%3E"
    "%3Crect x='225' y='75' width='8' height='95' fill='%2300c805'/%3E"
    "%3Crect x='240' y='90' width='8' height='80' fill='%23ef5350'/%3E"
    "%3Crect x='255' y='55' width='8' height='115' fill='%2300c805'/%3E"
    "%3Crect x='270' y='70' width='8' height='100' fill='%2300c805'/%3E"
    "%3Crect x='285' y='95' width='8' height='75' fill='%23ef5350'/%3E"
    "%3Crect x='300' y='50' width='8' height='120' fill='%2300c805'/%3E"
    "%3Crect x='315' y='65' width='8' height='105' fill='%2300c805'/%3E"
    "%3Crect x='330' y='85' width='8' height='85' fill='%23ef5350'/%3E"
    "%3Crect x='345' y='40' width='8' height='130' fill='%2300c805'/%3E"
    "%3Crect x='360' y='60' width='8' height='110' fill='%2300c805'/%3E"
    "%3Crect x='375' y='80' width='8' height='90' fill='%23ef5350'/%3E"
    "%3Crect x='390' y='55' width='8' height='115' fill='%2300c805'/%3E"
    "%3Crect x='405' y='70' width='8' height='100' fill='%2300c805'/%3E"
    "%3Crect x='420' y='100' width='8' height='70' fill='%23ef5350'/%3E"
    "%3Crect x='435' y='48' width='8' height='122' fill='%2300c805'/%3E"
    "%3Crect x='450' y='62' width='8' height='108' fill='%2300c805'/%3E"
    "%3Crect x='465' y='88' width='8' height='82' fill='%23ef5350'/%3E"
    "%3Crect x='480' y='52' width='8' height='118' fill='%2300c805'/%3E"
    "%3Crect x='495' y='72' width='8' height='98' fill='%2300c805'/%3E"
    "%3Crect x='510' y='95' width='8' height='75' fill='%23ef5350'/%3E"
    "%3Crect x='525' y='58' width='8' height='112' fill='%2300c805'/%3E"
    "%3Crect x='540' y='68' width='8' height='102' fill='%2300c805'/%3E"
    "%3Crect x='555' y='82' width='8' height='88' fill='%23ef5350'/%3E"
    "%3Crect x='570' y='50' width='8' height='120' fill='%2300c805'/%3E"
    "%3Crect x='585' y='75' width='8' height='95' fill='%2300c805'/%3E"
    "%3Crect x='600' y='90' width='8' height='80' fill='%23ef5350'/%3E"
    "%3Crect x='615' y='55' width='8' height='115' fill='%2300c805'/%3E"
    "%3Cline x1='140' y1='200' x2='640' y2='200' stroke='%232a2e39' stroke-width='1'/%3E"
    "%3Ctext x='150' y='230' fill='%23b2b5be' font-size='10' font-family='monospace'%3EOrder Book | Spread 0.02%25 | Latency 12ms%3C/text%3E"
    "%3C/svg%3E"
)

SECTION_CHART = (
    "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 280'%3E"
    "%3Crect width='400' height='280' rx='8' fill='%231e222d'/%3E"
    "%3Cpath d='M20 220 L60 180 L100 200 L140 140 L180 160 L220 100 L260 120 L300 80 L340 110 L380 60' "
    "stroke='%2300c805' stroke-width='2' fill='none'/%3E"
    "%3Ctext x='20' y='30' fill='%23ffffff' font-size='14' font-family='sans-serif'%3EMarktanalyse Engine%3C/text%3E"
    "%3C/svg%3E"
)
...
SECTION_AI = (
    "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 280'%3E"
    "%3Crect width='400' height='280' rx='8' fill='%231e222d'/%3E"
    "%3Crect x='40' y='60' width='320' height='160' rx='4' fill='%23131722' stroke='%232a2e39'/%3E"
    "%3Ccircle cx='120' cy='140' r='30' fill='none' stroke='%2300c805' stroke-width='2'/%3E"
    "%3Ctext x='200' y='130' fill='%23ffffff' font-size='13'%3EAI Strategy Core%3C/text%3E"
    "%3Ctext x='200' y='155' fill='%23b2b5be' font-size='11'%3ENeural Network Processing%3C/text%3E"
    "%3C/svg%3E"
)
...
def icon_svg(label):
    return (
        ...
        f"%3Crect width='48' height='48' rx='8' fill='%231e222d'/%3E"
        f"%3Ctext x='24' y='28' text-anchor='middle' fill='%2300c805' font-size='9' font-family='monospace'%3E{label}%3C/text%3E"
        "%3C/svg%3E"
    )
...
NEW_THEME_CSS = """<style id=ct-platform-theme>
...
NEW_FIXES_CSS = """<style id=ct-fixes>
...
NEW_PHONE_CSS = """<style id=phone-fix>
...
NEW_CALC_CSS = re.sub(
    r"#7B49E9|123,73,233",
    lambda m: "#00c805" if m.group(0) == "#7B49E9" else "0,200,5",
    open(FILE, encoding="utf-8").read().split("<style id=calc-fix>")[1].split("</style>")[0]
)
NEW_CALC_CSS = "<style id=calc-fix>" + NEW_CALC_CSS + "</style>"

FORM_NOTE = (
    '<p class=form__note><strong>Hinweis:</strong> Nach der Registrierung erhalten Sie einen Anruf '
    'von Ihrem persönlichen Account-Manager von Crypto-Traders Pro zur Verifizierung und '
    'Einrichtung Ihres Handelskontos im Terminal.</p>'
)

FOOTER_RISK = """<div class=footer-badges>
...
def main():
    ...
    # --- Meta & title ---
    html = html.replace(
        "<title>CRYPTO-TRADERS – KI für automatisierten Handel</title>",
        "<title>Crypto-Traders Pro – Algorithmische Handelsplattform</title>",
    )
    html = re.sub(
        r'<meta name=description content="[^"]*">',
        '<meta name=description content="Crypto-Traders Pro – Professionelle algorithmische Handelsplattform für digitale Assets. Terminal-Zugang mit Analyse-Tools, Order-Execution und KI-Strategien.">',
        html,
        count=1,
    )
    html = re.sub(
        r'<meta property=og:title content="[^"]*">',
        '<meta property=og:title content="Crypto-Traders Pro – Algorithmische Handelsplattform">',
        html,
        count=1,
    )
    html = re.sub(
        r'<meta property=og:description content="[^"]*">',
        '<meta property=og:description content="Erhalten Sie Zugang zu professionellen Analyse-Tools, hoher Order-Execution und automatisierten Handelsstrategien auf der Crypto-Traders Terminal-Plattform.">',
        html,
        count=1,
    )
    html = html.replace(
        '<meta property=og:site_name content="CRYPTO-TRADERS — Kryptowährungs-Handelsplattform">',
        '<meta property=og:site_name content="Crypto-Traders Pro">',
    )

    # --- CSS blocks ---
    html = re.sub(
        r"<style id=ct-platform-theme>.*?</style>",
        NEW_THEME_CSS,
        html,
        flags=re.DOTALL,
        count=1,
 ...
 Crypto-Traders Pro · Offizielle Handelsplattform · <a href=https://crypto-traders.co/ target=_blank>crypto-traders.co</a>
    ...
    # --- Logo & brand ---
    html = re.sub(
        r'<img src="data:image/svg\+xml[^"]*" alt="CRYPTO-TRADERS"[^>]*>',
        f'<img src="{LOGO_SVG}" alt="Crypto-Traders Pro" style="width:32px;height:32px;display:block;flex-shrink:0">',
        html,
    )
    html = html.replace(
        '<span style="font-weight:700;font-size:18px;color:#FFFFFF;letter-spacing:0.5px;">CRYPTO-TRADERS</span>',
        '<span style="font-weight:700;font-size:17px;color:#FFFFFF;letter-spacing:0.4px;">Crypto-Traders Pro</span>',
    )
    html = html.replace(
        '<span style="font-weight:700;font-size:16px;color:#ffffff;letter-spacing:0.5px;">CRYPTO-TRADERS</span>',
        '<span style="font-weight:700;font-size:15px;color:#ffffff;letter-spacing:0.4px;">Crypto-Traders Pro</span>',
    )

    html = html.replace(
        '<a href=#form-modal class="header__btn btn">\n Aktien kaufen',
        '<a href=#form-modal class="header__btn btn">\n Terminal-Zugang',
    )

    # --- H1 & subtitle ---
    html = html.replace(
        "<h1>CRYPTO-TRADERS – Professioneller KI-Handel mit Kryptowährungen und Aktien für jedermann</h1>",
        "<h1>Crypto-Traders™: Algorithmische Handelsplattform für digitale Assets.</h1>",
    )
    html = html.replace(
        "<p>Automatisierter Handel mit adaptiven Strategien für jedes Erfahrungsniveau. Wir zeigen Ihnen, wie Sie Erfolge erzielen</p>",
        "<p>Erhalten Sie Zugang zu professionellen Analyse-Tools, hoher Order-Execution und automatisierten Handelsstrategien auf Basis von KI. Registrieren Sie Ihr Konto für den Terminal-Zugang.</p>",
    )

    # --- Modal form title ---
    html = html.replace(
        "Beginnen Sie Ihre Investition mit der Öl- und Gasindustrie!",
        "Konto im Terminal eröffnen",
    )

    # --- Form titles ---
    html = html.replace(
        "<p>Benutzerkonto erstellen</p>",
        "<p>Konto im Terminal eröffnen</p>",
    )
    ...
    # --- Form notes after checkbox ---
    checkbox_block = """</label> </form>"""
    form_note_insert = f"""</label>\n{FORM_NOTE} </form>"""
    html = html.replace(checkbox_block, form_note_insert)

    # --- Hero image ---
    html = re.sub(
        r'(<div class=hero__image>\s*)<img src="data:image/[^"]*"[^>]*>',
        rf'\1<img src="{HERO_TERMINAL}" alt="Crypto-Traders Terminal" style="width:100%;border-radius:8px">',
        html,
        count=1,
    )

    # --- SEO section images ---
    seo_imgs = list(re.finditer(
        r'(<div class=seo__image>\s*)<img src="data:image/[^"]*"[^>]*>',
        html,
    ))
    replacements = [SECTION_CHART, SECTION_AI]
    offset = 0
    for i, m in enumerate(seo_imgs[:2]):
        src = replacements[i % len(replacements)]
        alt = "Marktanalyse" if i == 0 else "KI-Engine"
        new = f'{m.group(1)}<img src="{src}" alt="{alt}" style="width:100%;border-radius:8px">'
        start = m.start() + offset
        end = m.end() + offset
        html = html[:start] + new + html[end:]
        offset += len(new) - (m.end() - m.start())

    # --- Card icons: replace all base64 png icons in cards-block__icon ---
    icon_keys = list(ICONS.values())
    icon_idx = 0

    def replace_card_icon(m):
        nonlocal icon_idx
        src = icon_keys[icon_idx % len(icon_keys)]
        icon_idx += 1
        return f'<img src="{src}" alt="" width=48 height=48>'
...
Order-Execution und KI-gestützten Strategien.</p>""",
    ...
    # --- Footer risk block ---
    html = re.sub(
        r'<div class=footer__text>.*?</div>\s*</div>\s*</footer>',
        f'<div class=footer__text>{FOOTER_RISK}</div>\n </div>\n</footer>',
        html,
        flags=re.DOTALL,
        count=1,
    )
    ...
    # --- Hero2 heading ---
    html = html.replace(
        "<h2>Die Zukunft des Tradings ist da – seien Sie dabei!</h2>",
        "<h2>Crypto-Traders Terminal – Professioneller Marktzugang</h2>",
    )

    # --- Key section headings rebrand ---
    html = html.replace(
        "<h2>CRYPTO-TRADERS – Technologie, die die Spielregeln verändert hat</h2>",
        "<h2>Crypto-Traders Pro – Institutionelle Handelsinfrastruktur</h2>",
    )
    html = html.replace(
        "<h2>So funktioniert CRYPTO-TRADERS AI</h2>",
        "<h2>So funktioniert die Crypto-Traders Engine</h2>",
    )
    html = html.replace(
        "<h3><strong>Das Ergebnis – echte Vorteile für jeden Nutzer:</strong></h3>",
        "<h3><strong>Plattform-Vorteile im Überblick:</strong></h3>",
    )
    html = html.replace(
        "Nachgewiesene Genauigkeit 89–92 %",
        "Präzise Order-Execution",
    )
    html = html.replace(
        "<h2>CRYPTO-TRADERS: Tausende von Assets in einem einheitlichen Ökosystem</h2>",
        "<h2>Crypto-Traders Pro: Umfassendes Asset-Ökosystem</h2>",
    )
    html = html.replace(
        "<h2>Was der automatische Modus von CRYPTO-TRADERS kann</h2>",
        "<h2>Automatisierte Strategien im Crypto-Traders Terminal</h2>",
    )
    html = html.replace(
        "<h2>Die Leistungsfähigkeit der Künstlichen Intelligenz von CRYPTO-TRADERS in Zahlen</h2>",
        "<h2>Crypto-Traders Pro – Plattform-Kennzahlen</h2>",
    )
    html = html.replace(
        "<h2>Sicherheit und Zuverlässigkeit von CRYPTO-TRADERS</h2>",
        "<h2>Sicherheit und Compliance bei Crypto-Traders Pro</h2>",
    )
    html = html.replace(
        "<h2>Was unsere Benutzer sagen</h2>",
        "<h2>Erfahrungsberichte von Terminal-Nutzern</h2>",
    )
    html = html.replace(
        "<h2>Steigen Sie bei CRYPTO-TRADERS ein – nur 3 Klicks</h2>",
        "<h2>Terminal-Zugang in drei Schritten</h2>",
    )
    html = html.replace(
        "<h2>CRYPTO-TRADERS im Vergleich zur Konkurrenz</h2>",
        "<h2>Crypto-Traders Pro im Plattform-Vergleich</h2>",
    )
    html = html.replace(
        "<h2>CRYPTO-TRADERS in Zahlen</h2>",
        "<h2>Crypto-Traders Pro in Zahlen</h2>",
    )

    # --- Remove sensational accuracy mentions in visible card text ---
    html = html.replace(
        "<p>Drei Jahre Algorithmus-Training und Tests auf realen Märkten liefern konstant hohe Ergebnisse</p>",
        "<p>Optimierte Algorithmen für präzise Marktausführung auf institutionellem Niveau</p>",
    )

    FILE.write_text(html, encoding="utf-8")
    print(f"Done. File size: {FILE.stat().st_size // 1024} KB")
